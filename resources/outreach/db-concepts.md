# Outreach draft — Database System Concepts (7th ed.)

<!-- GENERATED from resources/registry.yaml (id: db-concepts).
...
**Subject:** Permission request — "Database System Concepts (7th ed.)" as a recommended text in an open CS curriculum

Dear Avi Silberschatz, Henry Korth, S. Sudarshan,
...
*Database System Concepts (7th ed.)* as a primary text for the following course(s):
