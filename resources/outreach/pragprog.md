# Outreach draft — The Pragmatic Programmer (20th Anniversary ed.)

<!-- GENERATED from resources/registry.yaml (id: pragprog).
...
- **Registry id:** pragprog
- **Status:** approval_needed (priority: medium)
- **Contact:** The Pragmatic Bookshelf — support@pragprog.com
- **Generated:** 2026-07-18

---

**To:** The Pragmatic Bookshelf — support@pragprog.com
**Subject:** Permission request — "The Pragmatic Programmer (20th Anniversary ed.)" as a recommended text in an open CS curriculum

Dear David Thomas, Andrew Hunt,
...
*The Pragmatic Programmer (20th Anniversary ed.)* as a primary text for the following course(s):
