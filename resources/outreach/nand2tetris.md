# Outreach draft — The Elements of Computing Systems (Nand2Tetris, 2nd ed.)

<!-- GENERATED from resources/registry.yaml (id: nand2tetris).
...
- **Registry id:** nand2tetris
- **Status:** approval_needed (priority: high)
- **Contact:** nand2tetris.org contact form / MIT Press permissions
- **Generated:** 2026-07-18

---

**To:** nand2tetris.org contact form / MIT Press permissions
**Subject:** Permission request — "The Elements of Computing Systems (Nand2Tetris, 2nd ed.)" as a recommended text in an open CS curriculum

Dear Noam Nisan, Shimon Schocken,
...
*The Elements of Computing Systems (Nand2Tetris, 2nd ed.)* as a primary text for the following course(s):
