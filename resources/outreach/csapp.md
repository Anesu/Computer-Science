# Outreach draft — Computer Systems: A Programmer's Perspective (3rd ed.)

<!-- GENERATED from resources/registry.yaml (id: csapp).
...
- **Registry id:** csapp
- **Status:** approval_needed (priority: high)
- **Contact:** Pearson permissions — https://www.pearson.com/en-us/contact-us/permissions.html
- **Generated:** 2026-07-18

---

**To:** Pearson permissions — https://www.pearson.com/en-us/contact-us/permissions.html
**Subject:** Permission request — "Computer Systems: A Programmer's Perspective (3rd ed.)" as a recommended text in an open CS curriculum

Dear Randal Bryant, David O'Hallaron,
...
*Computer Systems: A Programmer's Perspective (3rd ed.)* as a primary text for the following course(s):
