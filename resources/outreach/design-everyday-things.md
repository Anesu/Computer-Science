# Outreach draft — The Design of Everyday Things (revised ed.)

<!-- GENERATED from resources/registry.yaml (id: design-everyday-things).
...
- **Registry id:** design-everyday-things
- **Status:** approval_needed (priority: medium)
- **Contact:** Hachette Book Group permissions
- **Generated:** 2026-07-18

---

**To:** Hachette Book Group permissions
**Subject:** Permission request — "The Design of Everyday Things (revised ed.)" as a recommended text in an open CS curriculum
...
*The Design of Everyday Things (revised ed.)* as a primary text for the following course(s):
