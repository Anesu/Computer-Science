# Outreach draft — Types and Programming Languages

<!-- GENERATED from resources/registry.yaml (id: tapl).
...
- **Contact:** MIT Press rights & permissions — https://mitpress.mit.edu/rights-permissions/
- **Generated:** 2026-07-18

---

**To:** MIT Press rights & permissions — https://mitpress.mit.edu/rights-permissions/
**Subject:** Permission request — "Types and Programming Languages" as a recommended text in an open CS curriculum
...
*Types and Programming Languages* as a primary text for the following course(s):
