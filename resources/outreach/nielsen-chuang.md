# Outreach draft — Quantum Computation and Quantum Information

<!-- GENERATED from resources/registry.yaml (id: nielsen-chuang).
...
- **Registry id:** nielsen-chuang
- **Status:** approval_needed (priority: low)
- **Contact:** Cambridge University Press permissions — https://www.cambridge.org/about-us/rights-permissions
- **Generated:** 2026-07-18

---

**To:** Cambridge University Press permissions — https://www.cambridge.org/about-us/rights-permissions
**Subject:** Permission request — "Quantum Computation and Quantum Information" as a recommended text in an open CS curriculum

Dear Michael Nielsen, Isaac Chuang,
...
*Quantum Computation and Quantum Information* as a primary text for the following course(s):
