# Outreach draft — Discrete Mathematics and Its Applications (8th ed.)

<!-- GENERATED from resources/registry.yaml (id: rosen-discrete).
...
- **Registry id:** rosen-discrete
- **Status:** approval_needed (priority: low)
- **Contact:** McGraw Hill permissions — https://www.mheducation.com/permissions.html
- **Generated:** 2026-07-18

---

**To:** McGraw Hill permissions — https://www.mheducation.com/permissions.html
**Subject:** Permission request — "Discrete Mathematics and Its Applications (8th ed.)" as a recommended text in an open CS curriculum
...
*Discrete Mathematics and Its Applications (8th ed.)* as a primary text for the following course(s):
