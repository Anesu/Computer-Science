# Outreach draft — Designing Data-Intensive Applications (2nd ed.)

<!-- GENERATED from resources/registry.yaml (id: ddia).
...
- **Contact:** O'Reilly permissions — permissions@oreilly.com
- **Generated:** 2026-07-18

---

**To:** O'Reilly permissions — permissions@oreilly.com
**Subject:** Permission request — "Designing Data-Intensive Applications (2nd ed.)" as a recommended text in an open CS curriculum

Dear Martin Kleppmann, Chris Riccomini,
...
*Designing Data-Intensive Applications (2nd ed.)* as a primary text for the following course(s):
