# Outreach draft — A Philosophy of Software Design (2nd ed.)

<!-- GENERATED from resources/registry.yaml (id: aposd).
...
- **Contact:** John Ousterhout — Stanford CS faculty page
- **Generated:** 2026-07-18

---

**To:** John Ousterhout — Stanford CS faculty page
**Subject:** Permission request — "A Philosophy of Software Design (2nd ed.)" as a recommended text in an open CS curriculum

Dear John Ousterhout,
...
*A Philosophy of Software Design (2nd ed.)* as a primary text for the following course(s):
