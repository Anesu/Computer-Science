# Outreach draft — Artificial Intelligence: A Modern Approach (4th ed.)

<!-- GENERATED from resources/registry.yaml (id: aima).
...
- **Registry id:** aima
- **Status:** approval_needed (priority: medium)
...
**Subject:** Permission request — "Artificial Intelligence: A Modern Approach (4th ed.)" as a recommended text in an open CS curriculum

Dear Stuart Russell, Peter Norvig,
...
*Artificial Intelligence: A Modern Approach (4th ed.)* as a primary text for the following course(s):
